...
public class Player extends Actor {
    ...
    private de.flo.ballplatformer.utils.MobileController controller;

    private ParticleEffectController effectController;

    private Assets assets;

    public Player(Stage stage, World world, Vector2 startPos, PlatformerGame gameManager, de.flo.ballplatformer.utils.MobileController controller){
        this.world = world;
        this.stage = stage;
    ...
    private void initPlayerBox2D(){
        ...
        shape.setRadius(size / 2 / de.flo.ballplatformer.constants.Constants.PPM);
        ...
        groundSensor.set(new Vector2(-size / 3f / de.flo.ballplatformer.constants.Constants.PPM, (-(size / 2) - 1f) / de.flo.ballplatformer.constants.Constants.PPM), new Vector2(size / 3f / de.flo.ballplatformer.constants.Constants.PPM, (-(size / 2) - 1f) / de.flo.ballplatformer.constants.Constants.PPM));
        ...
        setSize(size / de.flo.ballplatformer.constants.Constants.PPM, size / de.flo.ballplatformer.constants.Constants.PPM);
        setScale(0);
    }
